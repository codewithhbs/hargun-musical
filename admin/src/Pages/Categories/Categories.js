...
const Categories = () => {
    ...
    const fetchCategories = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://api.hargunmusicals.com/api/v1/admin/category');
    ...
    const deleteCategory = async (id) => {
        if (window.confirm("Are you sure you want to delete this category?")) {
            setLoading(true);
            try {
                await axios.delete(`https://api.hargunmusicals.com/api/v1/admin/category-del/${id}`);
                toast.promise(
                    fetchCategories(),
                    {
    ...
    const AddCategory = async () => {
        ...
        try {
            await axios.post(
                `https://api.hargunmusicals.com/api/v1/admin/create/category`,
                { name }
            );
            fetchCategories();
    ...
    const updateCategory = async () => {
        ...
        try {
            await axios.put(
                `https://api.hargunmusicals.com/api/v1/admin/category/edit/${selectedCategory}`,
                { name }
            );
            fetchCategories();
    ...
    const AddSubCategory = async () => {
        ...
        try {
            await axios.post(
                `https://api.hargunmusicals.com/api/v1/admin/create/sub-category/${selectedCategory}`,
                { name }
            );
