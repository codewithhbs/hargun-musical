...
const Products = () => {
  ...
  const handleDeleteProduct = async (id) => {
    try {
      const res = await axios.delete(`https://api.hargunmusicals.com/api/v1/delete-product/${id}`)
      if (res.data.success) {
  ...
  const handleToggleShowOnHome = async (productId, currentValue) => {
    try {
      const response = await axios.put(`https://api.hargunmusicals.com/api/v1/update-show-home/${productId}`, {
