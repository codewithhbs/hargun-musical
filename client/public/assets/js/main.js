...
(function ($) {
  ...
  if (mainMenu.length) {
    ...
    mainMenu
      ...
      .append(
        '<i className="hgi hgi-stroke hgi-arrow-down-01 text-xl text-light-primary-text"></i>'
      );
  }
...
/*------ About Us Page Video Popup ------*/
  ...
  safeInit(function () {
    if ($.fn && $.fn.slick) {
      $(".sellzy-slider").slick({
    prevArrow:
      '<span className="slider-btn slider-prev size-12 rounded-full inline-flex items-center justify-center transition-colors duration-300 group/slider-btn cursor-pointer"><i className="hgi hgi-stroke hgi-arrow-left-01 text-[22px] text-light-primary-text transition-colors duration-300"></i></span>',
    nextArrow:
      '<span className="slider-btn slider-next size-12 rounded-full inline-flex items-center justify-center transition-colors duration-300 group/slider-btn cursor-pointer"><i className="hgi hgi-stroke hgi-arrow-right-01 text-[22px] text-light-primary-text transition-colors duration-300"></i></span>',
      });
