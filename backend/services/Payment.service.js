...
class PaymentService {
    constructor() {
        ...
        this.redirectUrl = process.env.REDIRECT_URL || 'https://api.hargunmusicals.com/payment-response';
    }
    ...
    async initiatePayment(paymentDetails) {
        try {
            ...
            const data = {
                ...
                callbackUrl: paymentDetails?.callbackUrl || 'https://api.hargunmusicals.com/api/v1/check-payment',
