...
const { createBrand, getBrands, getAllBrands, deleteBrand, updateBrand } = require("../controller/brandController");
...
router.get("/get-product-by-category-slug/:slug", getProductByCategorySlug);
...
router.post("/admin/create/brand", createBrand);
router.get("/admin/brand", getAllBrands);
router.get("/admin/brand/:id", getBrands);
router.put("/admin/brand/edit/:id", updateBrand);
router.delete("/admin/brand-del/:id", deleteBrand);
